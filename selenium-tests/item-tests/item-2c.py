...
def item_invalid_test():
    ...
    field_list[2].send_keys('aaaaaaaaaa')  # item input
    sleep(3)
    field_list[0].send_keys('90242')  # zipcode input
    field_list[1].send_keys('10')  # distance input
    sleep(5)  # pause for 3 seconds to show inputs in fields
